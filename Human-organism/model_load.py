...
for seq_record in SeqIO.parse("h_test_Pos_111.fasta", "fasta"): #Input positive fasta file
    innertest1()
...
for seq_record in SeqIO.parse("h_test_Neg_4261.fasta", "fasta"): #Input negative fasta file
    innertest2()
...
##LOAD MODEL####
model = load_model('transfer_m1.h5')
